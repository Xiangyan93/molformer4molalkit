...
class Evaluator:
    ...
    def _weighted_mean(df_metrics: pd.DataFrame) -> float:
        """Calculate weighted mean of metric values based on sample counts.

        For multi-task learning with missing values, tasks with more valid samples
        should contribute more to the average performance.
        """
